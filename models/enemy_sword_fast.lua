...
shirt = gr.material({ 0.4, 0.3, 0.0}, { 0.2, 0.2, 0.2}, 20, 9)
pants = gr.texturedmaterial({ 0.45, 0.35, 0.175}, { 0.2, 0.2, 0.2}, 50, 10)
flesh = gr.material({ 0.1, 0.5, 0.2}, { 0.1, 0.1, 0.1}, 80)
shoes = gr.material({ 0.43, 0.43, 0.43}, { 0.4, 0.4, 0.4}, 40)
...
ls:scale( shin_width, leg_height, shin_width)
