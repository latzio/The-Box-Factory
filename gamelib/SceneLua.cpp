...
// Create a material with a texture ID
extern "C"
int gr_texturedmaterial_cmd(lua_State* L)
{
    GRLUA_DEBUG_CALL;
...
// Set a node's material
extern "C"
int gr_node_set_map_cmd(lua_State* L)
{
    GRLUA_DEBUG_CALL;
...
static const luaL_reg grlib_functions[] = {
    ...
    {"texturedmaterial", gr_texturedmaterial_cmd},
    {0, 0}
};
